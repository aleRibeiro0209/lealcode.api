...
class Venda {
    ...
    public function update($id, $data) {
        $sql = "UPDATE tbVendas SET dataVenda = :dataVenda, formaPagamento = :formaPagamento, valorTotal = :valorTotal, descontoAplicado = :descontoAplicado, valorEntrada = :valorEntrada, quantidadeParcelas = :quantidadeParcelas, valorParcela = :valorParcela, jurosAplicados = :jurosAplicados, instituicaoFinanceira = :instituicaoFinanceira, taxasEncargosAdicionais = :taxasEncargosAdicionais, observacoes = :observacoes, idFuncionario = :idFuncionario, idVeiculo = :idVeiculo, idCliente = :idCliente WHERE idVenda = :id";
